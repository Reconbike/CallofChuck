...
Player.prototype.update = function(deltaTime)
{
	...
	var right = false;
	var jump = false;
	 // checking for keypress events inorder to calculate friction / Acceleration
	...
	{
	 // Forcing velocity of x to 0 will stop a known jiggle problem when hitting the ground
	 this.velocity.x = 0;
	}
	...
	// Forces a dead stop in velocity to avoid moving into the platform
